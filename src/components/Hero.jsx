...
const Hero = () => {
  ...
  const typedItems = ["Developer ","Freelancer ","Designer"];
    ...
    <section className={`relative w-full h-screen mx-auto`} id="hero" >
      ...
      >
        <div className="flex flex-col justify-center items-center mt-5">
          <div className="w-5 h-5 rounded-full bg-[#3046a7]" />
          <div className="w-1 sm:h-80 h-40 violet-gradient" />
        </div>

        <div>
          <h1 className={`${styles.heroHeadText} text-white shadow-sm`}>
            Olá! Meu nome é <span className="text-[#0c4dc7]">Iago Bruno</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-zinc-800`}>
            Eu sou {" "}
            <span
              className="typed"
              aria-hidden="true"
            ...
            <br />
            <b>Estou preparado para novos desafios e dedicado ao crescimento contínuo.</b>
          </p>
        </div>
      </div>
